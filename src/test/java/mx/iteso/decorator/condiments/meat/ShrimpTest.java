...
public class ShrimpTest {
    ...
    public void testDescription(){
        ...
        Taco decorator = new Shrimp(taco);
        Assert.assertTrue(decorator.getDescription().contentEquals("Any taco de camarón"));
    }
    ...
    public void testSize(){
    	for(Size size: Size.values())
    	{
    		...
    		if( size==Size.regular || size==Size.mega)
    			...
    			Assert.assertTrue(exception.getMessage().contentEquals("illegal shrimp taco size"));
    	}
    }
